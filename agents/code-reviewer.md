...
tools: Read, Grep, Glob, mcp__plugin_reka_rag__context_briefing, mcp__plugin_reka_rag__hybrid_search, mcp__plugin_reka_rag__get_adrs, mcp__plugin_reka_rag__get_patterns, mcp__plugin_reka_rag__memory
model: sonnet
memory: project
---
